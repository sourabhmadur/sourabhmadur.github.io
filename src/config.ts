...
export const homePageContent: HomePageContent = {
  ...
  bio: [
    ...
    "I studied at IIT Bombay, India's top-ranked engineering institute, before earning a degree in Computer Science with a concentration in AI from Columbia University.",
